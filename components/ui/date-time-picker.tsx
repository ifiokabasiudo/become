...
export function DateTimePicker({ date, setDate }: DateTimePickerProps) {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild className="z-10 bg-transparent">
        <Button
          suppressHydrationWarning
          variant={'outline'}
          className={cn(
            'w-[280px] justify-start text-left font-normal bg-card dark-nav-border-color text-white hover:buttons hover:text-white',
      ...
      <PopoverContent className="w-auto p-0 border dark-nav-border-color bg-transparent">
        <Calendar
          className='text-white bg-card rounded-t'
          mode="single"
